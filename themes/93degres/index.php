        ...
        <div id="first-post">
                    <?php if('travelguide' === get_post_type()): ?>
                        <div class="post post-guide col-xs-pull-0 col-xs-48 col-md-pull-3">
                            <div id="first-post-texte" class="col-xs-42 col-xs-pull-0 col-xs-offset-3 col-md-offset-4 col-md-17">
                                <?php
                                    $id = get_the_id();
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                            <div id="first-post-image" class="col-xs-42 col-xs-offset-3 col-md-offset-3 col-md-24">
