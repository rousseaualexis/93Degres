<?php if ('guides' === get_post_type()): ?>
    <div class="post post--guide col-xs-42 col-xs-offset-3 col-md-13 col-md-offset-1 ">
            <?php
...
<?php elseif ('conseils' === get_post_type()): ?>
    <div class="post post--conseil col-xs-42 col-xs-offset-3 col-md-13 col-md-offset-1 ">
            <?php
                $thumbnail = get_field('thumbnail');
                $thumbnail_url = $thumbnail['sizes']['thumbnail'];
                $id = get_the_id();
...
<?php elseif ('carnets' === get_post_type()): ?>
    <div class="post post--article col-xs-42 col-xs-offset-3 col-md-13 col-md-offset-1 ">
            <?php
                $thumbnail = get_field('thumbnail');
                $thumbnail_url = $thumbnail['sizes']['thumbnail'];
                $id = get_the_id();
